...
def scalar_projection(vector_u, vector_v):
    """
    Calculate the scalar projection of vector_u onto vector_v.
    ...
    Returns:
        float: The scalar projection of vector_u onto vector_v.
    """
    ...
    # Calculate the magnitude of vector_v
    ...
    scalar_proj = dot_product / magnitude_v
...
def main():
    ...
    try:
        ...
        scalar_proj = scalar_projection(vector_u, vector_v)
        print(f"The scalar projection of vector_u onto vector_v is {scalar_proj:.2f}")
